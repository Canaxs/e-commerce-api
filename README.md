...
A monolithic application with features such as adding and removing products, menus that can be managed with admin panel.
...
Project Link: [https://github.com/Canaxs/e-commerce-api](https://github.com/Canaxs/e-commerce-api)
